  ...
  return (
    <div className="oura-card mb-4">
      ...
      <div className="flex items-center">
        <CircleScore score={data.score} color="#5D8FD9" size="large" icon="activity" />
        <div className="ml-4">
          <div className="flex items-center mb-3">
            <CircleScore score={data.hrvScore} color="#5D8FD9" size="small" icon="heart" />
            <div>
          ...
          <div className="flex items-center">
            <CircleScore score={80} color="#5D8FD9" size="small" icon="heart" />
            <div>
